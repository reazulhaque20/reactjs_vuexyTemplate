...
const product10 = getPublicUrl('/images/ecommerce-images/product-10.png')
const product11 = getPublicUrl('/images/ecommerce-images/product-11.png')
const product12 = getPublicUrl('/images/ecommerce-images/product-12.png')
const product13 = getPublicUrl('/images/ecommerce-images/product-13.png')
const product14 = getPublicUrl('/images/ecommerce-images/product-14.png')
const product15 = getPublicUrl('/images/ecommerce-images/product-15.png')
const product16 = getPublicUrl('/images/ecommerce-images/product-16.png')
const product17 = getPublicUrl('/images/ecommerce-images/product-17.png')
const product18 = getPublicUrl('/images/ecommerce-images/product-18.png')
const product19 = getPublicUrl('/images/ecommerce-images/product-19.png')
const product2 = getPublicUrl('/images/ecommerce-images/product-2.png')
const product20 = getPublicUrl('/images/ecommerce-images/product-20.png')
const product24 = getPublicUrl('/images/ecommerce-images/product-24.png')
const product3 = getPublicUrl('/images/ecommerce-images/product-3.png')
const product4 = getPublicUrl('/images/ecommerce-images/product-4.png')
const product5 = getPublicUrl('/images/ecommerce-images/product-5.png')
const product6 = getPublicUrl('/images/ecommerce-images/product-6.png')
const product7 = getPublicUrl('/images/ecommerce-images/product-7.png')
const product8 = getPublicUrl('/images/ecommerce-images/product-8.png')
const product9 = getPublicUrl('/images/ecommerce-images/product-9.png')
export const db = {
  products: [
    {
      id: 1,
